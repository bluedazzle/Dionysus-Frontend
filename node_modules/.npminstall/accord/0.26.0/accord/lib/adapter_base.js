...
(function() {
  var Adapter, File, W, clone, fs, partialRight, path, requireEngine, resolve, resolvePath,
  ...
  Adapter = (function() {
    ...
    Adapter.prototype.renderFile = function(file, opts) {
      ...
      return (new File(file)).read({
        encoding: 'utf8'
      }).then(partialRight(this.render, Object.assign({
        filename: file
      }, opts)).bind(this));
    };
    ...
    Adapter.prototype.compileFile = function(file, opts) {
      ...
      return (new File(file)).read({
        encoding: 'utf8'
      }).then(partialRight(this.compile, Object.assign({
        filename: file
      }, opts)).bind(this));
    };
    ...
    Adapter.prototype.compileFileClient = function(file, opts) {
      ...
      return (new File(file)).read({
        encoding: 'utf8'
      }).then(partialRight(this.compileClient, Object.assign(opts, {
        filename: file
      })).bind(this));
    };
